...
ALTER TABLE products ADD COLUMN IF NOT EXISTS detail_description TEXT NOT NULL DEFAULT '';
ALTER TABLE products ADD COLUMN IF NOT EXISTS recommended_for TEXT NOT NULL DEFAULT '';
ALTER TABLE products ADD COLUMN IF NOT EXISTS cautions TEXT NOT NULL DEFAULT '';

ALTER TABLE orders ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW();

ALTER TABLE ai_logs ADD COLUMN IF NOT EXISTS session_id VARCHAR(120);
ALTER TABLE ai_logs ADD COLUMN IF NOT EXISTS request_type VARCHAR(30) NOT NULL DEFAULT 'general';

INSERT INTO shopping_sessions (session_id, created_at, updated_at, last_seen_at)
SELECT DISTINCT session_id, NOW(), NOW(), NOW()
FROM (
    SELECT session_id FROM cart_items
    UNION
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE constraint_name = 'cart_items_session_id_fkey'
